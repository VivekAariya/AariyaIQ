...
function generateEmailHTML(type: EmailType, data: EmailData): string {
  ...
  `;
    ...
    <div style="text-align: center; padding: 20px 0;">
      <div style="background: linear-gradient(135deg, #06b6d4 0%, #8b5cf6 100%); width: 80px; height: 80px; border-radius: 50%; margin: 0 auto 20px; display: flex; align-items: center; justify-content: center; box-shadow: 0 0 30px rgba(6, 182, 212, 0.3);">
    ...
    <h2 style="text-align: center; background: linear-gradient(135deg, #06b6d4 0%, #8b5cf6 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; font-size: 28px; margin-bottom: 10px;">Verify Your Email</h2>
    <p style="text-align: center; color: #64748b; font-size: 16px; margin-bottom: 30px;">Welcome to the future of learning, ${data.recipientName}!</p>
    
    <div style="background: linear-gradient(135deg, rgba(6, 182, 212, 0.1) 0%, rgba(139, 92, 246, 0.1) 100%); border: 1px solid rgba(6, 182, 212, 0.2); border-radius: 12px; padding: 25px; margin: 25px 0; text-align: center;">
      <h3 style="color: #0f172a; margin: 0 0 15px 0; font-size: 20px;">Almost There!</h3>
      <p style="color: #475569; margin: 0 0 20px 0; line-height: 1.6;">
        You're just one click away from joining the AariyaIQ community. Click the button below to verify your email address and unlock access to cutting-edge technology courses.
      </p>
      ${
          data.verificationLink
              ? `
        <a href="${data.verificationLink}" style="display: inline-block; background: linear-gradient(135deg, #06b6d4 0%, #8b5cf6 100%); color: white; text-decoration: none; padding: 16px 32px; border-radius: 8px; font-weight: bold; font-size: 16px; margin: 10px 0; box-shadow: 0 4px 15px rgba(6, 182, 212, 0.3); transition: all 0.3s ease;">
    ...
    <div style="background: linear-gradient(135deg, rgba(15, 23, 42, 0.05) 0%, rgba(30, 41, 59, 0.05) 100%); border-radius: 8px; padding: 20px; margin: 25px 0;">
      <h4 style="color: #0f172a; margin: 0 0 15px 0; font-size: 18px;">🚀 What's Next?</h4>
      <ul style="color: #475569; margin: 0; padding-left: 20px; line-height: 1.8;">
        <li>Access your personalized learning dashboard</li>
        <li>Browse our cutting-edge technology courses</li>
    ...
    ${
      ...
      <div style="background: rgba(239, 68, 68, 0.1); border: 1px solid rgba(239, 68, 68, 0.2); border-radius: 8px; padding: 15px; margin: 20px 0;">
        <p style="margin: 0; color: #7f1d1d; font-size: 14px;">
          <strong>⚠️ Security Note:</strong> This verification link will expire in 24 hours. If the button doesn't work, copy and paste this link into your browser:
        </p>
        <p style="margin: 10px 0 0 0; word-break: break-all; color: #06b6d4; font-size: 12px;">
          ${data.verificationLink}
        </p>
      </div>
    `
    ...
    <p style="color: #64748b; text-align: center; margin-top: 30px;">
      Need help? Contact our support team at <a href="mailto:hello@aariyatech.co.uk" style="color: #06b6d4; text-decoration: none;">hello@aariyatech.co.uk</a>
    </p>
  `;
            break;
