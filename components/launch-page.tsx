...
import { CalendarDays, MapPin, Mail, Twitter, Linkedin, Instagram, Rocket, Users, BookOpen, Award } from "lucide-react"
              ...
              <div className="text-center lg:text-left space-y-8">
                <div className="space-y-4">
                  ...
                  <p className="text-lg text-gray-200 max-w-2xl drop-shadow-md">
                    Empowering professionals with cutting-edge skills and knowledge for the digital age. Join us for the
                    official launch from our Brighton office.
                  </p>
                </div>
              ...
              <div className="space-y-8">
                  ...
                  <CardContent className="p-8">
                    <div className="text-center space-y-6">
                      ...
                      <p className="text-gray-300">
                        Be the first to know when AariyaIQ launches. Get exclusive early access and special offers.
                      </p>
                ...
                <div className="text-center space-y-4">
                  ...
                  <div className="flex justify-center gap-4">
                    <Button variant="outline" size="icon" className="border-white/30 hover:bg-white/20 text-white">
