                        ...
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            <Card className="bg-slate-800/50 border-slate-700 shadow-xl backdrop-blur-md">
                                <CardContent className="p-6">
                                    ...
                                    <h1 className="text-3xl sm:text-4xl font-bold tracking-tight bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-500 text-transparent bg-clip-text mb-4">
                                        {course.course_title}
                                    </h1>
                                ...
                                <CardContent>
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-slate-400 text-sm mb-2">{instructor.email}</p>
