...
export function HeroSection() {
  ...
  return (
    <section className="w-full py-12 md:py-24 lg:py-32 bg-black/3 backdrop-blur-sm text-white">
      <div className="container px-4 md:px-6">
        <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
          <div className="flex flex-col justify-center p-8 md:p-10 lg:p-12 rounded-xl bg-black/20 backdrop-blur-md border border-white/10 shadow-lg relative neon-container neon-always-on overflow-visible">
            ...
            <div className="space-y-6 md:space-y-8">
              <div className="space-y-3">
                <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none whitespace-nowrap">
                ...
                <p className="text-xl font-medium tracking-tight sm:text-2xl xl:text-3xl/none whitespace-nowrap text-gray-200">
...
`}</style>
          <div className="flex items-center justify-center">
            <div className="relative h-[350px] w-[400px] rounded-lg bg-black/30 backdrop-blur-xl border border-white/10 shadow-lg neon-container neon-always-on overflow-visible">
              {/* Neon border elements */}
              <div className="neon-right absolute"></div>
              <div className="neon-bottom absolute"></div>
              <div className="neon-left absolute"></div>
              ...
              <div className="absolute inset-0 overflow-hidden rounded-lg">
                ...
                {/* Terminal Content */}
                <div
                  className="p-4 overflow-hidden h-[calc(100%-2rem)]"
                  style={{
                    fontFamily:
                ...
                >
                  <div className="space-y-2">
                    ...
                    {currentLine < lines.length && (
                      <div className={`whitespace-nowrap inline-flex items-center ${lines[currentLine].color}`}>
