...
import { BookOpen, Home, LogOut, Menu, Settings, User, X } from "lucide-react"
        ...
        <div className="flex h-full flex-col">
          ...
          <nav className="flex-1 space-y-1">
            ...
            <Link
              ...
              className={`flex items-center rounded-md px-3 py-2 text-sm font-medium ${
                pathname.startsWith("/dashboard/courses") ? "bg-cyan-600/50 text-white font-bold" : "hover:bg-white/10"
              }`}
            >
            ...
            <Link
              ...
              className={`flex items-center rounded-md px-3 py-2 text-sm font-medium ${
                pathname === "/dashboard/learner-application" ? "bg-white/20 text-white" : "hover:bg-white/10"
              }`}
            >
