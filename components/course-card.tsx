        ...
        <div className="group relative h-full">
            ...
            <Card className="overflow-hidden transition-all hover:shadow-md h-full flex flex-col">
                <div className="aspect-video relative overflow-hidden">
                    ...
                    />
                    <ShareButton courseId={course.id} courseTitle={course.course_title} />
                </div>
                <CardHeader className="flex-none">
                    <CardTitle className="line-clamp-1">{course.course_title}</CardTitle>
                    <CardDescription className="line-clamp-2 h-10">{course.short_description}</CardDescription>
                </CardHeader>
