import { Facebook, Instagram, Linkedin, Link as LinkTree } from "lucide-react";
            ...
            <div className="container flex flex-col gap-8 py-8 md:py-12 relative">
                <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="mt-2">
                            <p className="text-xs text-gray-400 mb-2 whitespace-nowrap">
                                Learning Management System & Platform By:
                            </p>
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <nav className="flex flex-row gap-4 mt-2">
                            ...
                            <Link
                                href="https://www.facebook.com/people/AariyaTech/61560363147395/"
                                target="_blank"
                                className="text-gray-400 hover:text-white relative neon-container neon-hover-only p-2 rounded-full"
                                aria-label="Facebook"
                            >
                            ...
                            <Link
                                href="https://www.instagram.com/aariyatechglobal/"
                                target="_blank"
                                className="text-gray-400 hover:text-white relative neon-container neon-hover-only p-2 rounded-full"
                            ...
                            <Link
                                href="https://linktr.ee/aariyatechuk"
                                target="_blank"
                                className="text-gray-400 hover:text-white relative neon-container neon-hover-only p-2 rounded-full"
                                aria-label="Instagram"
                            >
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mt-4">
                    <p className="text-sm text-gray-400">
                        &copy; {new Date().getFullYear()} AariyaTech UK. All rights reserved.
                    </p>
                    <p className="text-sm text-gray-400">
