                    ...
                    <div className="flex items-center space-x-2 sm:space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-400 text-sm sm:text-base">
                                Manage instructor details and permissions
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:space-x-6 space-y-4 sm:space-y-0">
                            ...
                            <div className="flex-1">
                                <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-3 mb-2 gap-2 sm:gap-0">
                                    ...
                                    <Badge
                                        className={`${getStatusColor(instructor.profile_status)} flex items-center space-x-1 mt-1 sm:mt-0 w-fit`}
                                    >
                        ...
                        <form action={handleInstructorProfileFormSubmit} name="instructorProfileForm">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                                ...
                                <div className="mt-4">
                                    <Button
                                        variant={"outline"}
                                        className="w-full sm:w-auto p-5"
                                        type="submit"
                                        disabled={isPending}
                                    >
