          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_300px] lg:gap-12">
            <div className="space-y-6">
              <div>
                ...
                <p className="text-muted-foreground">Complete the form below to apply as an instructor</p>
              </div>

              <Card className="border border-white/20 bg-black/20 backdrop-blur-sm dark:border-white/10">
                <CardHeader>
                  <CardTitle>Personal Information</CardTitle>
                  <CardDescription>Provide your details to begin the application process</CardDescription>
                </CardHeader>
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start space-x-2">
                        ...
                        >
                          I agree to the terms and conditions and understand that my application is subject to approval
                        </Label>
                      </div>
                    </div>
