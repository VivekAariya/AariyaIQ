            ...
            <div className="bg-black/40 backdrop-blur-sm p-4 rounded-lg border border-white/10">
              ...
              <div className="space-y-2">
                <Button variant="instructor" size="sm" className="w-full" asChild>
                  <Link href="/admin/dashboard/courses/new">Create New Course</Link>
                </Button>
                <Button variant="instructor" size="sm" className="w-full" asChild>
                  <Link href="/admin/dashboard/users">Manage Learners</Link>
                </Button>
                <Button variant="outline" size="sm" className="w-full border-white/20" asChild>
                  <Link href="/admin/dashboard/logs">View System Logs</Link>
                </Button>
              </div>
            </div>
          </div>
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between">
            ...
            <Button variant="instructor" asChild>
              <Link href="/admin/dashboard/courses/new">Add New Course</Link>
            </Button>
          </div>
              ...
              <div key={course.id} className="grid grid-cols-5 gap-4 border-t p-4">
                ...
                <div className="flex space-x-2">
                  <Button variant="outline" size="sm" asChild>
                    <Link href={`/admin/dashboard/courses/${course.id}`}>Edit</Link>
                  </Button>
          ...
          <div className="mt-4 flex justify-center">
            <Button variant="outline" asChild>
              <Link href="/admin/dashboard/courses">View All Courses</Link>
            </Button>
          </div>
        </div>
      </div>
